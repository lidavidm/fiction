    ...
    extends FictionActivity
{
    ...
    public void onSongChange(Song song) {
        ...
        mAdapter.onPageScrollStateChanged();
    }
    ...
    public class CoverAdapter
        ...
        public TextView instantiateItem(ViewGroup container, int position) {
            ...
            Log.d("fiction", "getting"+Integer.toString(position)+Integer.toString(offset));
        ...
        private Song getSong(int offset) {
            if (mActivity.isServiceBound()) {
                ...
                if (position + offset > (queue.getCount() - 1)) return null;
